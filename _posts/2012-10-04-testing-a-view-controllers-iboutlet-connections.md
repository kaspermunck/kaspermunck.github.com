...
date: 2012-10-04
permalink: /2012/10/testing-a-view-controllers-iboutlet-connections/
---
...
![Instantiating View Hierarchy](http://developer.apple.com/library/ios/featuredarticles/ViewControllerPGforiPhoneOS/Art/loading_a_view_into_memory_2x.png)
...
Assume a storyboard containing the view of `MyViewController`. First, in the Storyboard, select `MyViewController` and, in Utilities View, select the Identity Inspector. In here you will find an Identity Setting named `Storyboard ID`. This is used to identify the viewcontroller. Assign a unique, descriptive value, eg `MyViewController`.
