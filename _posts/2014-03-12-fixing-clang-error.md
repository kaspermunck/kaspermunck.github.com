...
date: 2014-03-12
permalink: /2014/03/fixing-clang-error/
---
...
```
As explicitly noted in the release notes, this is a temporary fix. It does, however, solve the immediate problem (not being able to install certain gems), and is sufficient until the maintainers of the gems update their projects to not violate the treat-warnings-as-errors constraint.
